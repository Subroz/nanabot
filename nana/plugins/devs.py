...
async def sd_reveal(client, message):
    ...
    await message.delete()
    a = 'nana/file.png'
    await client.download_media(message.reply_to_message.photo or message.reply_to_message.video, file_name=a)
    if tags:
        await client.send_document('me', a)
    else:
        await client.send_document(message.chat.id, a)
    os.remove(a)
